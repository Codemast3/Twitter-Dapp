...
const clientId = "BOxgiwFTrSULHgL5Foop7bvXLyS5fJd6PRyhjIx15-BeNk0GuFeB9fRJhHqdqY3Br41NCbX9S5g_Jxqm1ptYNzQ"; // get from https://dashboard.web3auth.io
      ...
      try {
        const web3auth = new Web3AuthCore({
          ...
          chainConfig: {
            ...
            rpcTarget: "https://polygon-mumbai.infura.io/v3/1da3154c02754dc295720423cf3c0cd4", // This is the mainnet RPC we have added, please pass on your own endpoint while creating an app
          },
        });
          ...
          adapterSettings: {
            ...
            loginConfig: {
              ...
              jwt: {
                ...
                verifier: "GGG-MYAPP", // Please create a verifier on the developer dashboard and pass the name here

                typeOfLogin: "twitter", // Pass on the login provider of the verifier you've created

                clientId: "BzSGn2DfvezbDpvz84w4mMpLkoe6boa3", // Pass on the clientId of the login provider here - Please note this differs from the Web3Auth ClientID. This is the JWT Client ID
              },
